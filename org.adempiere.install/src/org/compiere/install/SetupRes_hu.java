...
public class SetupRes_hu extends ListResourceBundle
{
	...
	{ "AdempiereServerSetup", 	"Sleektiv Szerver Beállítása" },
	{ "Ok", 					"Ok" },
	{ "File", 					"Fájl" },
	{ "Exit", 					"Kilépés" },
	{ "Help", 					"Súgó" },
	{ "PleaseCheck", 			"Kérem ellenőrizze" },
	{ "UnableToConnect", 		"Nem sikerült elérni a súgót az Sleektiv web oldalán" },
	//
	{ "AdempiereHomeInfo", 		"Sleektiv Home is the main Folder" },
	{ "AdempiereHome", 			"Sleektiv Home" },
	...
	{ "DatabaseUserInfo", 		"Database Sleektiv User ID" },
	{ "DatabaseUser", 			"Database User" },
	{ "DatabasePasswordInfo", 	"Database Sleektiv User Password" },
	...
	{ "AdminEMailInfo", 		"Sleektiv Administrator EMail" },
	...
	{ "JNPPort", 				"JNP Port" },
	{ "MailUserInfo", 			"Sleektiv Mail User" },
	{ "MailUser", 				"Mail User" },
	{ "MailPasswordInfo", 		"Sleektiv Mail User Password" },
	...
	{ "ErrorAdempiereHome", 		"Error Sleektiv Home" },
