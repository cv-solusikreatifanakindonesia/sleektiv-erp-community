// Usage:   WinEnv SLEEKTIV_HOME JAVA_HOME
...
if (Args.length != 2)
{
  WScript.Echo("Usage: cscript WinEnv.js SLEEKTIV_HOME JAVA_HOME"
...
SysEnv("SLEEKTIV_HOME") = home;
WScript.Echo ("SET SLEEKTIV_HOME="+ home);
