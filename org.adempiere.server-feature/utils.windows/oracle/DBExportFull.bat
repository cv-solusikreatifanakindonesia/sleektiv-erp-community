...
@sqlplus %1/%2@%ADEMPIERE_DB_SERVER%:%ADEMPIERE_DB_PORT%/%ADEMPIERE_DB_NAME% @%SLEEKTIV_HOME%\utils\%ADEMPIERE_DB_PATH%\Daily.sql


@exp %1/%2@%ADEMPIERE_DB_SERVER%:%ADEMPIERE_DB_PORT%/%ADEMPIERE_DB_NAME% FILE=%SLEEKTIV_HOME%\data\ExpDatFull.dmp Log=%SLEEKTIV_HOME%\data\ExpDatFull.log CONSISTENT=Y STATISTICS=NONE FULL=Y
