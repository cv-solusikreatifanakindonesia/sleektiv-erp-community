...
@Echo	Importing idempiere DB from %SLEEKTIV_HOME%\data\seed\Adempiere%5.dmp (%ADEMPIERE_DB_NAME%)
...
@psql -h %ADEMPIERE_DB_SERVER% -p %ADEMPIERE_DB_PORT% -d %ADEMPIERE_DB_NAME% -U %2 -f %SLEEKTIV_HOME%/data/seed/Adempiere%5.dmp
...
@Echo		SLEEKTIV_HOME	e.g. D:\idempiere
